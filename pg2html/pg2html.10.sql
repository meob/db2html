...
--          1.0.19 Both owner/schema in matrix, latest versions update, version 13 support (99%: pg_pltemplate is not available in 13+)
...
--
--          Notice: use pg2html.sql that better supports PG 10+ with conditional psql scripting
...
select 'using: <I><b>pg2html.10.sql</b> v.1.0.21' as info;
...
select '<tr><td>',type,
       ...
       '<td>',auth_method, '<td>',options, '<td>',error
