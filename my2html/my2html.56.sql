-- Program:	 my2html.56.sh
--		 MySQL (5.6) DBA Database SQL report in HTML
...
select 'my2html MySQL (5.6) Statistics</title></head><body>';
...
select '<li><A HREF="#stat">Performance Statistics</A> (<A HREF="#stat56">5.6</A>)</li>' ;
...
select 'using: <I><b>my2html.56.sh</b> v.1.0.17 (2020-01-14)';
...
select ' <td>', if(SUBSTRING_INDEX(version(),'.',2) in ('8.0','5.7','5.6', '10.4','10.3','10.2','10.1'), 'YES', 'NO') ; -- supported version
select ' <td>', if(SUBSTRING_INDEX(version(),'.',2) in ('8.0','5.7', '10.4','10.3'), 'YES', 'NO') ; -- last2 releases
select ' <td>', if(SUBSTRING_INDEX(version(),'-',1)
    in ('8.0.16','5.7.26','5.6.43', '10.1.40','10.2.25','10.3.16','10.4.6','5.5.64',
        '8.0.17','5.7.27','5.6.44', '10.1.41','10.2.26','10.3.17','10.4.7','5.5.65',
        '8.0.18','5.7.28','5.6.45', '10.1.42','10.2.27','10.3.18','10.4.8','5.5.66'), 'YES', 'NO') ; -- last2 updates (and the next)
select ' <td>', if(SUBSTRING_INDEX(version(),'-',1)
    in ('8.0.17','5.7.27','5.6.44', '10.1.41','10.2.26','10.3.17','10.4.7','5.5.65',
        '8.0.18','5.7.28','5.6.45', '10.1.42','10.2.27','10.3.18','10.4.8','5.5.66'), 'YES', 'NO') ; -- last updates (and the next)
select '<td>Last Releases: 8.0.17, 5.7.27, 5.6.44' from dual; -- notes
select ' <br>Last Releases (MariaDB): 10.4.7, 10.3.16, 10.2.25, 10.1.40, 5.5.64' from dual;
select '</table><p>' ;
...
select '<P><table border="2"><tr><td><b>Performance Schema Statistics (5.6)</b></td></tr>' ;
select '</table><p>';
