REM Program:	custom_19c.sql
REM 		Oracle 19c PlugIn
REM Version:	1.0.0
...
REM		First version with new useful queries available on 19
...
set heading off
select '<P><a id="custO"></a><a id="19c"></a><h2>Oracle 19c features</h2>' h from dual;
